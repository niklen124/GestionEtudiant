...
public class TableHeaderAlignment implements TableCellRenderer {
    ...
    public TableHeaderAlignment(JTable userTable) {
        this.oldHeaderRenderer = userTable.getTableHeader().getDefaultRenderer();
        this.oldCellRenderer = userTable.getDefaultRenderer(Object.class);
        userTable.setDefaultRenderer(Object.class, new TableCellRenderer() {
            @Override
