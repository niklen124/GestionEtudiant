...
import com.gag.swing.ButtonCustom;
import com.gag.swing.MenuItem;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void createButtonMenu() {
        ...
        cmdMenu.setIcon(new ImageIcon(getClass().getResource("/com/gag/icon/menu.png")));
        cmdMenu.setBorder(new EmptyBorder(5, 12, 5, 12));
    }
    
    private void createButtonLogout() {
        cmdLogOut = new ButtonCustom();
        cmdLogOut.setIcon(new ImageIcon(getClass().getResource("/com/gag/icon/exit.png")));
    }
